document.addEventListener("DOMContentLoaded", () => {
    ...
    const filteredNekretnine = urlParams.get('filteredNekretnine');

    if (filteredNekretnine) {
        const nekretnine = JSON.parse(decodeURIComponent(filteredNekretnine));
        spojiNekretnine(document.getElementById('divNekretnine'), { filtrirajNekretnine: () => nekretnine }, '');
    }
});
